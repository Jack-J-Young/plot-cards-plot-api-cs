...
namespace BL.Tests
{
    public class PlotCardFileManagerTests
    {
        ...
        [InlineData(1, 1,
            new byte[] {
                137, 112, 108, 116,
                0, 0, 0, 8, 115, 73, 90, 101, 0, 0, 0, 1, 0, 0, 0, 1,
                //0, 0, 0, 0, 104, 68, 65, 116
            }
        )]
        [InlineData(2, 2,
            new byte[] {
                137, 112, 108, 116,
                0, 0, 0, 8, 115, 73, 90, 101, 0, 0, 0, 2, 0, 0, 0, 2,
                //0, 0, 0, 0, 104, 68, 65, 116
            }
        )]
        [InlineData(3, 3,
            new byte[] {
                137, 112, 108, 116,
                0, 0, 0, 8, 115, 73, 90, 101, 0, 0, 0, 3, 0, 0, 0, 3,
                //0, 0, 0, 0, 104, 68, 65, 116
            }
        )]
        [InlineData(4, 4,
            new byte[] {
                137, 112, 108, 116,
                0, 0, 0, 8, 115, 73, 90, 101, 0, 0, 0, 4, 0, 0, 0, 4,
                //0, 0, 0, 0, 104, 68, 65, 116
            }
        )]
